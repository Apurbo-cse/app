...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $cates = Cate::where('status', '1')->limit(3)->get();
        ...
        $products = Product::where('status', '1')->select(['id', 'title', 'offer_price', 'regular_price', 'image', 'category_id', 'stock', 'tag_id'])->orderBy('id', 'desc')->limit(16)->get();
        $blogs = Blog::where('status', '1')->orderBy('id', 'DESC')->limit(10)->get();
        return view('frontend.home', compact('sliders', 'cates','featuredCategories', 'hotItems', 'latestItems', 'products', 'blogs'));
    }
    ...
    {
        $videos = Video::orderBy('created_at', 'DESC')->where('status', '1')->get();
    ...
    public function fairTrade()
    {
        ...
        return view('frontend.fairTrade', compact('fairTrades','fairTradeInfo'));
    }
