...
@section('main-content')
            ...
            @foreach($cates as $cate)
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="single-banner">
                        ...
                        <img src="{{$cate->image}}" alt="assets/static/p2.JPG">
                        <div class="content">
                            <h3>{{$cate->title}}</h3>
                            <a href="/productList">Discover Now</a>
                        </div>
                    </div>
                </div>
                <!-- /End Single Banner  -->
    ...
    <!--                <div class="single-banner">-->
    <!--                    <img src="{{asset('/')}}images/static/s1.JPG" alt="assets/static/s1.JPG">-->
    <!--                    <div class="content">-->
    <!--                        <p>Kid&#039;s</p>-->
    <!--                        <h3>Ladies Cotton Kurti Sha -->
                            <!--<br>Up to<span> 3%</span>-->
    <!--                        </h3>-->
    ...
    <!--            <div class="col-lg-6 col-md-6 col-12">-->
    <!--                <div class="single-banner">-->
    <!--                    <img src="{{asset('/')}}images/static/s2.JPG" alt="assets/static/s2.JPG">-->
    <!--                    <div class="content">-->
    <!--                        <p>Men&#039;s Fashion</p>-->
    <!--                        <h3>Melange Casual Black -->
                            <!--<br>Up to<span> </span>-->
    <!--                        </h3>-->
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="shop-single-blog">
                        <img src="{{asset($blog->image)}}" style="height:270px" alt="blog">
                        <div class="content">
