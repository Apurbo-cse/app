...
@section('main-content')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Materials & Techniques Info</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <section class="about-us section">
        <div class="container">
            ...
            <div class="row d-flex col-md-12 mb-4 mt-5 pb-3 p-3" style="background-color: rgb(254, 254, 254);box-shadow: 2px 5px 8px 2px #888888;">
